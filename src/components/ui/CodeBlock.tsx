...
export function CodeBlock({
  ...
  return (
    <div
      dir="ltr"
      className={cn(
        "relative overflow-hidden rounded-xl border border-line bg-[#0c0c14] text-left shadow-card",
        className,
      )}
    >
      {/* gradient hairline */}
      ...
      <div className="flex items-center justify-between border-b border-white/10 px-4 py-2.5">
        <div className="flex items-center gap-2">
          ...
          <span className="ms-3 inline-flex items-center gap-1.5 font-mono text-xs text-slate-400">
      ...
      <div className="overflow-x-auto">
        <pre className="min-w-full p-4 font-mono text-[13px] leading-relaxed text-slate-100">
          <code>
            {lines.map((line, i) => (
